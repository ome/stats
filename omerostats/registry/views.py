...
from omerostats.registry.models import Agent, IP, Hit, Continent, Country, \
                                       Version, AgentVersion
from omerostats.registry.models import MapForm, VersionForm
from omerostats.registry.delegator import IPforXML, month_year_table, sorted_table
    ...
    if mapform.is_valid():
        ...
        if continent or countries:
            ...
            if continent and country_ids:
                args.append((Q(ip__continent__id=continent.id) | Q(ip__country__in=country_ids)))
            elif continent:
        ...
        try:
            for row in result:
                ...
                p = IPforXML(id=ip_id, ip=ip, latitude=latitude, longitude=longitude, agent_name=agent_name, org=org)
        ...
        data = serializers.serialize('json', ips, fields=('latitude', 'longitude', 'ip', 'org'))
